...
const Help = () => {
    ...
    return (
        <div>
            <img src={Img1} alt="img1" className="absolute left-0" />
            <img src={Img2} alt="img2" className="absolute right-0" />
            <div className="flex items-center justify-center">
                <div className=" relative mt-0 w-[55%] flex flex-col  h-[100vh]  ">
                    ...
                    <div className="p-4">
                        {items.map((item, index) => (
                            <div key={index} className={`flex flex-col lg:flex-row ${index % 2 !== 0 ? 'lg:flex-row-reverse' : ''} items-center rounded-lg overflow-hidden mb-8`}>
                                ...
                                <img src={item.img} alt={item.title} className="w-auto lg:w-1/2 h-44 lg:h-auto object-cover" />
                            </div>
                        ))}
